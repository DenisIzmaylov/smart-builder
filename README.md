 ...
 * Look at [Ember CLI](http://www.ember-cli.com/user-guide/) and [LinemanJS](http://linemanjs.com/) to inspire and get useful solutions. Thanks to [Andrey Listochkin](https://github.com/listochkin).
